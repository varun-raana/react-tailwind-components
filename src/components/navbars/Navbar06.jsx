...
function Navbar06() {
	...
	return (
		<nav className="xl:max-w-screen-lg md:max-w-full sticky top-2 w-full bg-[#e6dee9] bg-opacity-80 rounded-xl drop-shadow backdrop-blur-sm">
			<div className="py-6 lg:px-8 px-4 flex items-center justify-between relative">
				...
				<div className="lg:hidden">
					...
					{isMenuOpen && (
						<div className="fixed top-0 left-0 w-full bg-[#e6dee9] rounded-xl drop-shadow">
